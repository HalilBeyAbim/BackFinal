...
{
    public partial class Teacher_Add : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dribbble = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Language = table.Column<byte>(type: "tinyint", nullable: false),
                    TeamLeader = table.Column<byte>(type: "tinyint", nullable: false),
                    Devolopment = table.Column<byte>(type: "tinyint", nullable: false),
